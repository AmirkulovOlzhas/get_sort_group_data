...
contact_list = ["Содержание парков", "Еңбекші ішкі орам", "ТҰРАН ТАЗАЛЫҚ ДЕ СУППОРТ", "Нурсат ТБО",
                "КАРАТАУ ЦЕНТР.УЛИЦЫ♻️", 'ТБО, Туран, Азат, Мирас', 'ТБО ГОРОД', 'Больница РОЩА']

#
not_saved_contact = ['Нурлан', 'Gulaim', 'Жанар', 'Жанара', 'Гани']

contact_dict = {0: 'P', 1: '-', 2: '', 3: 'N_TBO', 4: 'K', 5: 'TBO', 6: 'TBO_City', 7: 'BR'}
